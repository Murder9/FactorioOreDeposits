...
public final class ModConfig {
    ...
    public static final ModConfigSpec.BooleanValue ONLY_DROP_IF_MINED_BY_PLAYER = BUILDER
            .comment("When true, automation only consumes a deposit cycle if the resource can be inserted into an inventory above or below the deposit. Player mining and explosions still consume and drop normally. When false, automation drops the resource in-world if no inventory accepts it.")
